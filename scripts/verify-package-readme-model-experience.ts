...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-video-editor': { kind: 'indirect', reason: 'The form submits an ordinary user message; dsh-tool-video owns the model-facing tools and prompt section.' },
  ...
  'packages/video/video-editor': { kind: 'indirect', reason: 'The service interface delegates model rendering to dsh-tool-video.' },
  'packages/video/video-ffmpeg': { kind: 'indirect', reason: 'The FFmpeg backend delegates model rendering to dsh-tool-video.' },
